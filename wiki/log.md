...
- **Philadelphia Chapter Profile & Major Distribution**: Updated `v2/about.html`, `about.html`, `dashboard.html` reference alignment, and `wiki/entities/site/About-Page-Content.md` with Technical Expertise separated into a 3-column row, Philadelphia Chapter Profile (2026), active roster membership structure (Regular 54%, Graduate 26%, Undergraduate 15%, Lifetime 5%), official Chapter Major Distribution (Biomedical & Health 44%, Engineering & Physical 26%, Computing & AI/Data 12%, Social/Education 10%, Math/Business/Other 8%), and regional institution listings focused on the Greater Philadelphia / Delaware Valley footprint (UPenn, Drexel, Temple, Jefferson, Penn State, UDel, Swarthmore, Bryn Mawr, Haverford, Saint Joseph's, CHOP, Wistar, Fox Chase).
