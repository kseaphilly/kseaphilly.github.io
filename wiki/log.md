...
- **Joint Seminar #1 Concluded**: Updated Sept 10 kickoff seminar status to Concluded across production pages (`index.html`, `events.html`, `v2/index.html`, `v2/events.html`). Added 2 on-site event photos (`20260910-seminar-photo1.jpg`, `20260910-seminar-photo2.jpg`) with lightbox viewing and updated ticker across all v2 pages.
